...
<template>
  <header
    class="flex items-center justify-between gap-2 md:gap-3 border-b border-theme-border px-3 md:px-4 pt-[calc(0.625rem+max(var(--sat),env(safe-area-inset-top,0px)))] pb-2.5 md:pt-3 md:pb-3 shrink-0 bg-theme-card z-30"
  >
