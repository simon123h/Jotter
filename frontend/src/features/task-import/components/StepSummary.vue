...
<template>
  <div class="space-y-6 py-6 text-center">
    <div class="flex flex-col items-center">
      ...
      <h4 class="text-sm font-bold text-theme-text-main">{{ t('importWizard.importCompleted') }}</h4>
      <p class="text-xs text-theme-text-muted mt-1">{{ t('importWizard.importCompletedDesc') }}</p>
    </div>
    ...
    <div class="grid grid-cols-3 gap-3 max-w-sm mx-auto">
      <div class="p-3 bg-emerald-500/5 border border-emerald-500/10 rounded-lg text-center">
        <span class="text-xs text-theme-text-muted block">{{ t('importWizard.statCreated') }}</span>
      ...
      <div class="p-3 bg-yellow-500/5 border border-yellow-500/10 rounded-lg text-center">
        <span class="text-xs text-theme-text-muted block">{{ t('importWizard.statSkipped') }}</span>
      ...
      <div class="p-3 bg-red-500/5 border border-red-500/10 rounded-lg text-center">
        <span class="text-xs text-theme-text-muted block">{{ t('importWizard.statFailed') }}</span>
    ...
    <p class="text-[11px] text-theme-text-muted max-w-md mx-auto leading-relaxed">
      {{ t('importWizard.importFooterInfo') }}
    </p>
  </div>
</template>
