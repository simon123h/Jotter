export const de = {
  ...
  settingsView: {
    ...
    timeboxingTitle: 'Time Blocking',
    timeboxStartHourLabel: 'Tagesplan-Startuhrzeit',
    timeboxEndHourLabel: 'Tagesplan-Enduhrzeit',
  },
  views: {
    board: 'Board',
    list: 'Liste',
  ...
  timeblock: {
    ...
    addBox: 'Neuer Zeitblock',
    newTitle: 'Zeitblock erstellen',
    editTitle: 'Zeitblock bearbeiten',
    deleteTitle: 'Zeitblock löschen',
    deleteConfirm: 'Möchtest du diesen Zeitblock wirklich löschen? Die zugeordneten Aufgaben bleiben unverändert erhalten.',
    titleLabel: 'Titel *',
    ...
    addSelectedTasks: 'Aufgaben hinzufügen',
    addSelectedTooltip: 'Ausgewählte Aufgabe(n) in diesen Zeitblock einplanen',
    noTasksSelectedHelper: 'Wähle Aufgaben auf dem Board aus und klicke hier zum Einplanen',
    unallocate: 'Aus Zeitblock entfernen',
