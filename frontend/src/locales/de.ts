export const de = {
  ...
  toasts: {
    ...
    syncErrorTitle: 'Synchronisationsfehler',
    projectCreateError: 'Projekt konnte nicht erstellt werden: {message}',
    bulkDeleteError: 'Massenlöschung fehlgeschlagen: {message}',
    bulkMoveError: 'Massenverschiebung fehlgeschlagen: {message}',
    bulkTagError: 'Massen-Tagging fehlgeschlagen: {message}',
    bulkPriorityError: 'Massen-Priorisierung fehlgeschlagen: {message}',
    bulkColorError: 'Massen-Farbänderung fehlgeschlagen: {message}',
    bulkPlanError: 'Massen-Planung fehlgeschlagen: {message}',
    bulkDueDateError: 'Massen-Fälligkeitsdatum fehlgeschlagen: {message}',
    bulkPostponeError: 'Massen-Verschiebung fehlgeschlagen: {message}',
    bulkArchiveError: 'Massen-Archivierung fehlgeschlagen: {message}',
    bulkMarkDoneError: 'Massen-Erledigung fehlgeschlagen: {message}',
    bulkConsolidateError: 'Massen-Zusammenfassung fehlgeschlagen: {message}',
  },
  speech: {
    dictate: 'Diktieren',
    ...
    permissionDenied: 'Mikrofonzugriff wurde verweigert. Bitte erteilen Sie die Berechtigung.',
    error: 'Fehler bei der Spracherkennung: {message}',
  },
  ...
  settingsView: {
    ...
    timeboxingTitle: 'Time Boxing',
    timeboxWeekModeLabel: 'Standard-Wochenansicht',
    timeboxWeekModeDesc: 'Wähle, ob der Kalender standardmäßig 5 Tage (Mo–Fr) oder alle 7 Tage (Mo–So) anzeigt.',
    timeboxStartHourLabel: 'Kalender-Startuhrzeit',
    timeboxEndHourLabel: 'Kalender-Enduhrzeit',
  },
  views: {
    board: 'Board',
    list: 'Liste',
  ...
  timebox: {
    ...
    workweek: 'Mo–Fr (5 Tage)',
    fullweek: 'Mo–So (7 Tage)',
    addBox: 'Neue Timebox',
    newTitle: 'Timebox erstellen',
    editTitle: 'Timebox bearbeiten',
    deleteTitle: 'Timebox löschen',
    deleteConfirm: 'Möchtest du diese Timebox wirklich löschen? Die zugeordneten Aufgaben bleiben unverändert erhalten.',
    titleLabel: 'Titel *',
    titlePlaceholder: 'z. B. Deep Work: Refactoring',
    dateLabel: 'Datum',
    startLabel: 'Startzeit',
    endLabel: 'Endzeit',
    colorLabel: 'Akzentfarbe',
    tasksDrawerTitle: 'Verfügbare Aufgaben',
    activeProject: 'Projekt',
    todayPlanned: 'Heute',
    allTasks: 'Alle Aufgaben',
    searchTasksPlaceholder: 'Aufgaben durchsuchen...',
    dropTasksHere: 'Aufgaben hierher ziehen zum Zuordnen',
    unallocate: 'Aus Timebox entfernen',
    showDrawer: 'Aufgabenleiste einblenden',
    hideDrawer: 'Aufgabenleiste ausblenden',
    noTasksToSchedule: 'Keine passenden Aufgaben zum Einplanen gefunden.',
    resize: 'Ziehen zum Anpassen der Dauer',
  },
  matrix: {
