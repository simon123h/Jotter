export const en = {
  ...
  settingsView: {
    ...
    timeboxWeekModeLabel: 'Default Week View',
    timeboxWeekModeDesc: 'Choose whether the calendar displays 5 days (Mon-Fri) or all 7 days by default.',
    timeboxStartHourLabel: 'Calendar Start Hour',
    timeboxEndHourLabel: 'Calendar End Hour',
  },
  views: {
    board: 'Board',
    list: 'List',
  ...
  timebox: {
    ...
    fullweek: 'Mon–Sun (7d)',
    addBox: 'New Timebox',
    newTitle: 'Create Timebox',
    editTitle: 'Edit Timebox',
    deleteTitle: 'Delete Timebox',
    deleteConfirm: 'Are you sure you want to delete this timebox? Allocated tasks will remain intact.',
    titleLabel: 'Title *',
    ...
    tasksDrawerTitle: 'Unallocated Tasks',
    activeProject: 'Project',
    todayPlanned: 'Today',
    allTasks: 'All Tasks',
    searchTasksPlaceholder: 'Search tasks...',
    dropTasksHere: 'Drag & drop tasks here to allocate',
    unallocate: 'Remove from timebox',
    showDrawer: 'Show Tasks Drawer',
    hideDrawer: 'Hide Tasks Drawer',
    noTasksToSchedule: 'No matching tasks found to schedule.',
